...
import { Inter as FontSans, Lato, Nunito, Roboto, Libre_Baskerville, Libre_Franklin} from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={cn(fontSans.variable, nunito.variable, lato.variable, libre_franklin.variable, libre_baskerville.variable, roboto.variable)}> 

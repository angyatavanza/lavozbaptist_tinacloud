...
export const SectionIntro = ({ title, image, children }: SectionIntroProps) => {
  return (
        ...
        <div className="mt-12 lg:mt-0 lg:w-[37rem] lg:flex-none">
          <FadeIn>
            <div
              ...
              aria-hidden="true"
            />
            <h2 className="mt-2 font-nunito font-semibold text-pretty text-center text-[34px] leading-[44px] md:text-5xl md:leading-[60px] tracking-tight text-primary">
              {title}
            </h2>

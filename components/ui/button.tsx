...
const buttonVariants = cva(
  "font-roboto inline-flex items-center justify-center min-w-25 gap-3 whitespace-nowrap rounded-sm font-semibold text-sm leading-[20px] transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-primary-button text-primary-button-foreground shadow-xs hover:bg-primary-button/90",
        destructive:
          "bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        //Outline button is currently used for the hero component
        outline:
          "border bg-transparent border-secondary-background-white text-primary-button-foreground shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        defaultvariant:
          "bg-primary-button-variant text-primary-button-foreground shadow-xs hover:bg-primary-button-variant/90",
        secondary:
          "bg-secondary-button text-secondary-button-foreground shadow-xs hover:bg-secondary-button/80",
        ghost:
          "bg-transparent text-primary-button hover:bg-transparent hover:underline dark:text-primary-foreground min-w-0",

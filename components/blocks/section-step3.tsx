...
import { PageBlocksStep3 } from '@/tina/__generated__/types';
import { TinaIcon } from '../icon';
import { List, ListItem } from "../list";

export const Step3  = ({ data }: { data: PageBlocksStep3 }) => {
  return (
...
export const step3BlockSchema: Template = {
    name: "step3",
    label: "Step3",
    ui: {
        previewSrc: "/blocks/step3.png",
        defaultItem: {
